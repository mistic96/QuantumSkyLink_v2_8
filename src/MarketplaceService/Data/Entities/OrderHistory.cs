...
/// <summary>
/// Represents the history of changes to marketplace orders
/// </summary>
[Table("OrderHistory")]
[Index(nameof(OrderId))]
[Index(nameof(CreatedAt))]
[Index(nameof(Status))]
public class OrderHistory : ITimestampEntity
{
    /// <summary>
    ...
    /// <summary>
    /// Gets or sets the marketplace order this history record is for
    /// </summary>
    [Required]
    ...
    /// <summary>
    /// Gets or sets the status at this point in the order lifecycle
    /// </summary>
    [Required]
    ...
    /// <summary>
    /// Gets or sets the marketplace order for this history record
    /// </summary>
