...
/// <summary>
/// Validator for the customer trading pair model
/// </summary>
public class CustomerTradingPairValidator : AbstractValidator<CustomerTradingPair>
{
    /// <summary>
    /// Initializes a new instance of the <see cref="CustomerTradingPairValidator"/> class
    /// </summary>
    public CustomerTradingPairValidator()
    {
        RuleFor(x => x.Id)
            .NotEmpty().WithMessage("Customer trading pair ID is required");
        ...
        RuleForEach(x => x.Alerts)
            .SetValidator(new CustomerTradingPairAlertValidator());
    }
}
