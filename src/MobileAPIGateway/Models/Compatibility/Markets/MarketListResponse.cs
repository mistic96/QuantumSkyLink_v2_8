...
/// <summary>
/// Market list response model for compatibility with the old MobileOrchestrator
/// </summary>
public class MarketListResponse
{
    ...
    /// </summary>
    public List<MarketItem> Markets { get; set; } = new List<MarketItem>();
...
/// <summary>
/// Market item model for compatibility with the old MobileOrchestrator
/// </summary>
